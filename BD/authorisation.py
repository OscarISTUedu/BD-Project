...
Изменение - Талон,Участки,Пациенты
Удаление - Талон,Участки,Пациенты
Добавление - Талон,Участки,Пациенты
...
doctor_permission = Permission.objects.filter(codename__in=['view_doctor', 'view_patient','view_ticket','view_diagnosis','change_diagnosis_in_ticket'])
patient_permission = Permission.objects.filter(codename__in=['view_doctor', 'view_neighborhood'])
reception_permission = Permission.objects.filter(codename__in=['view_patient','change_patient','delete_patient','add_patient', 'view_neighborhood','add_neighborhood','delete_neighborhood','change_neighborhood','view_ticket','add_ticket','delete_ticket','change_ticket'])
